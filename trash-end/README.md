...
Earlier files are preserved under [The Big Question legacy](the-big-question/legacy/README.md). They are not clutter to be cleaned up; they are the archaeological record of the argument changing its mind.
...
See [Epistemic status](concepts/epistemic-status.md) for the full convention and [Epistemic notes for The Big Question](the-big-question/epistemic-notes.md) for known pressure points.
